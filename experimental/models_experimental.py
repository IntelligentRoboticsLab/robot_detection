...
class ObjectDetectionTask(lightning.LightningModule):
    ...
    def _shared_eval_step(self, batch):
        ...
        print(encoded_target_classes.flatten())
        with torch.no_grad():
            acc = accuracy(
            predicted_class, encoded_target_classes)
    ...
    def training_step(self, batch, batch_idx):
        total_loss, location_loss, classification_loss, accuracy = self._shared_eval_step(batch)
        self.log_dict(
            {
                "train/total_loss": total_loss,
                "train/location_loss": location_loss,
                "train/classification_loss": classification_loss,
                "train/accuracy/robot": accuracy,
            },
            on_step=True,
            prog_bar=True,
        )
        ...
        self.log_dict(
            {
                ...
                "validation/accuracy/robot": accuracy
            }
        )
